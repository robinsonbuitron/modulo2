...
if (!isset($_SESSION['s_username'])) {
	...
	<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
		...
		<tbody>
			...
			$conexion->conectar();
			$resultado = $conexion->consulta("select tu.idusuario, ti.siglas, tp.nombprivi, tu.nomape from tusuario tu join tinstitucion ti on tu.idinstitucion=ti.idinstitucion join tprivilegios tp on tp.idprivilegios=tu.idprivilegios where tp.idprivilegios!='00001'");
